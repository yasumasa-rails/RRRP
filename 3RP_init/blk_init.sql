...
CREATE OR REPLACE  VIEW "RAILS"."R_LOCAS" 
...
values(0,'0','system',0,'2099/12/31')
;
CREATE OR REPLACE  VIEW "RAILS"."R_USRGRPS" 
...
CREATE TABLE "SIO_R_SECTS" 
 ...
 CREATE 
OR REPLACE  VIEW "RAILS"."R_PERSONS" ( 
  "ID"
  , "PERSON_ID"
  , "PERSON_REMARK"
  , "PERSON_EXPIREDATE"
...
and person.USRGRPS_ID = usrgrp.ID
 ...
 CREATE OR REPLACE  VIEW "RAILS"."UPD_PERSONS"
 ...
 ;
  CREATE OR REPLACE  VIEW "RAILS"."CHIL_PRJNOS"
 ("ID", "PRJNO_ID_CHIL","PRJNO_CODE_CHIL","PRJNO_NAME_CHIL") AS 
  select  prjno.id, prjno.id prjno_id_chil ,prjno.code prjno_code_chil,prjno.name prjno_name_chil
 from prjnos prjno
 
 ;
 CREATE 
OR REPLACE  VIEW "RAILS"."R_CHRGS" ( 
  "ID"
  , "CHRG_ID"
  , "CHRG_REMARK"
  , "CHRG_EXPIREDATE"
...
where
  ...
  ;
  CREATE 
OR REPLACE  VIEW "RAILS"."R_BLKTBS" ( 
  "BLKTB_CONTENTS"
  , "ID"
  , "BLKTB_ID"
...
CREATE TABLE "RAILS"."SCREENS" 
  ...
  ;
  CREATE 
OR REPLACE  VIEW "RAILS"."R_SCREENS" ( 
  "SCREEN_EXPIREDATE"
  , "SCREEN_UPDATED_AT"
  , "SCREEN_STRWHERE"
...
CREATE TABLE "RAILS"."TBLINKS" 
  ...
  ;
  CREATE 
OR REPLACE  VIEW "RAILS"."R_TBLINKS" ( 
  "TBLINK_CODEL"
  , "TBLINK_EXPIREDATE"
  , "TBLINK_UPDATED_AT"
  , "TBLINK_SEQNO"
...
CREATE TABLE "RAILS"."FIELDCODES" 
  ...
  ;
  CREATE 
OR REPLACE VIEW "RAILS"."R_FIELDCODES" ( 
...
CREATE TABLE "RAILS"."TBLFIELDS" 
  ...
  CREATE 
OR REPLACE  VIEW "RAILS"."R_TBLFIELDS" ( 
  "TBLFIELD_CONTENTS"
  , "TBLFIELD_BLKTB_ID"
  , "BLKTB_CONTENTS"
  , "BLKTB_ID"
...
;
CREATE 
OR REPLACE  VIEW "RAILS"."R_BLKUKYS" ( 
  "BLKUKY_GRP"
  , "ID"
  , "BLKUKY_ID"
  , "BLKUKY_REMARK"
...
;
CREATE 
OR REPLACE  VIEW "RAILS"."R_SCREENFIELDS" ( 
...
CREATE TABLE "RAILS"."CHILSCREENS" 
  ...
  ;
CREATE 
OR REPLACE  VIEW "RAILS"."R_CHILSCREENS" ( 
  "CHILSCREEN_GRP"
...
CREATE TABLE "RAILS"."BUTTONS" 
  ...
  ;
  CREATE 
OR REPLACE  VIEW "RAILS"."R_BUTTONS" ( 
  "BUTTON_CODE"
  , "BUTTON_EXPIREDATE"
  , "BUTTON_UPDATED_AT"
  , "BUTTON_CONTENTS"
...
CREATE TABLE "RAILS"."USEBUTTONS" 
  ...
  CREATE 
OR REPLACE  VIEW "RAILS"."R_USEBUTTONS" ( 
  "ID"
  , "USEBUTTON_ID"
  , "USEBUTTON_CONTENTS"
  , "USEBUTTON_REMARK"
...
;
CREATE 
OR REPLACE  VIEW "RAILS"."R_REPORTS" ( 
  "REPORT_CONTENTS"
...
CREATE TABLE "RAILS"."TBLINKFLDS" 
  ...
  CREATE 
OR REPLACE  VIEW "RAILS"."R_TBLINKFLDS" ( 
  "TBLINKFLD_CONTENTS"
  , "ID"
  , "TBLINKFLD_ID"
  , "TBLINKFLD_REMARK"
...
;
  ...
  CREATE OR REPLACE  VIEW "RAILS"."R_SHELFNOS" ("SHELFNO_CODE", "SHELFNO_EXPIREDATE", "SHELFNO_UPDATED_AT", "SHELFNO_NAME", "SHELFNO_REMARK", "SHELFNO_CREATED_AT", "SHELFNO_UPDATE_IP", "ID", "SHELFNO_ID", "SHELFNO_PERSON_ID_UPD", "PERSON_ID_UPD", "PERSON_CODE_UPD", "PERSON_NAME_UPD", "SHELFNO_CONTENTS", "SHELFNO_LOCA_ID_SHELFNO", "LOCA_ID_SHELFNO", "LOCA_EXPIREDATE_SHELFNO", "LOCA_CODE_SHELFNO", "LOCA_NAME_SHELFNO", "LOCA_ABBR_SHELFNO", "LOCA_ZIP_SHELFNO", "LOCA_COUNTRY_SHELFNO", "LOCA_PRFCT_SHELFNO", "LOCA_ADDR1_SHELFNO", "LOCA_ADDR2_SHELFNO", "LOCA_TEL_SHELFNO", "LOCA_FAX_SHELFNO", "LOCA_MAIL_SHELFNO") AS 
