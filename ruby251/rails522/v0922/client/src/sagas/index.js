...
const { signin,login, starred, stargazers } = actions
...
const signinUrl = signin => `/api/auth/${signin}/starred`
...
export const fetchLogin       = fetchEntity.bind(null, user, api.fetchLogin)
export const fetchSignin       = fetchEntity.bind(null, user, api.fetchSignin)
