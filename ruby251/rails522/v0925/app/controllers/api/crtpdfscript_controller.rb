...
###https://www.rubydoc.info/gems/rubyXL/RubyXL/Parser
###  require 'rubyXL/convenience_methods'
###  binary = @upload[0].excel.download
###  workbook = RubyXL::Parser.parse_buffer(binary)
###   wsheet.page_margins.left right,left,top,bottom,header,footer
###   cell.font_name
###   cell.font_size
###   cell.font_color
###   cell.fill_color
###   get_column_width_raw(column_index = 0)
###   worksheet.get_row_height(0)
###   sheet.page_setup.page_size A3,A4,A5,B4,B5 -->8,9,11,12,13
###   罫線　cell.get_cell_border.bottom.style　　-->top left,bottom,right
###         二重線:double  極太:thick  太線:medium 標準:thin   破線:dashed   ドット線:dotted
