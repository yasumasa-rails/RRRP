 ...
 alter table purschs DROP COLUMN crrs_id CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　crrs_idが削除　2021-05-02 16:04:26 +0900' 
 ---- where  pobject_code_sfd = 'crrs_id'
 alter table shpschs DROP COLUMN crrs_id CASCADE;
...
pursch.amt_sch  pursch_amt_sch,
  ...
  opeitm.loca_name_opeitm  loca_name_opeitm 
 from purschs   pursch,
  r_persons  person_upd ,  r_opeitms  opeitm ,  r_prjnos  prjno ,  r_chrgs  chrg ,  r_suppliers  supplier ,  r_shelfnos  shelfno_to 
  where       pursch.persons_id_upd = person_upd.id      and pursch.opeitms_id = opeitm.id      and pursch.prjnos_id = prjno.id      and pursch.chrgs_id = chrg.id      and pursch.suppliers_id = supplier.id      and pursch.shelfnos_id_to = shelfno_to.id     ;
