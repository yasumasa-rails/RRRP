 ...
 alter table  trngantts ALTER COLUMN qty  TYPE numeric(18,6);

 alter table  trngantts ALTER COLUMN qty_alloc  TYPE numeric(16,6);

 alter table  trngantts ALTER COLUMN qty_stk  TYPE numeric(38,6);

 alter table  trngantts  ADD COLUMN qty_pare_alloc numeric(22,6);
...
,trngantt_qty_alloc  numeric (16,6)
