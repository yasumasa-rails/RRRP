 ...
 alter table prdacts DROP COLUMN qty CASCADE;
 ...
 ---- where  pobject_code_sfd = 'qty'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　qtyが削除　2020-04-22 13:28:04 +0900' 
 ---- where  pobject_code_sfd = 'qty'
 alter table  prdacts  ADD COLUMN qty_stk numeric(22,6);

 alter table  prdacts ALTER COLUMN qty_case  TYPE numeric(22,0);

 alter table prdacts  ADD COLUMN sno_prdord varchar(50);

 alter table prdacts  ADD COLUMN sno_prdinst varchar(50);

 alter table prdacts  ADD COLUMN cno_prdinst varchar(50);

 alter table prdacts  ADD COLUMN cno_prdord varchar(50);
