 ...
 alter table puracts DROP COLUMN shelfnos_id_in CASCADE;
 ...
 ---- where  pobject_code_sfd = 'shelfnos_id_in'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　shelfnos_id_inが削除　2020-01-22 19:58:48 +0900' 
 ---- where  pobject_code_sfd = 'shelfnos_id_in'
...
puract.price  puract_price,
 ...
 from puracts   puract,
  r_chrgs  chrg ,  r_prjnos  prjno ,  r_suppliers  supplier ,  r_crrs  crr_pur ,  r_shelfnos  shelfno_to ,  r_locas  loca_to ,  r_persons  person_upd ,  r_opeitms  opeitm 
  where       puract.chrgs_id = chrg.id      and puract.prjnos_id = prjno.id      and puract.suppliers_id = supplier.id      and puract.crrs_id_pur = crr_pur.id      and puract.shelfnos_id_to = shelfno_to.id      and puract.locas_id_to = loca_to.id      and puract.persons_id_upd = person_upd.id      and puract.opeitms_id = opeitm.id     ;
