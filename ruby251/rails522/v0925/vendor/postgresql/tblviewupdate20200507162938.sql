 ...
 alter table  instks  ADD COLUMN qty_sch numeric(22,6);

 alter table  lotstkhists  ADD COLUMN qty_sch numeric(22,6);

 alter table  outstks  ADD COLUMN qty_sch numeric(22,6);
