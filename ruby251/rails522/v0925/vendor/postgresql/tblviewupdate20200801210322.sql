 ...
 alter table  pricemsts  ADD COLUMN processseq numeric(38,0);
...
pricemst.processseq  pricemst_processseq
...
,pricemst_rule_price  varchar (1) 
,pricemst_price  numeric (38,4)
,pricemst_processseq  numeric (38,0)
,pricemst_over_f  varchar (1) 
,pricemst_tblname  varchar (30) 
,pricemst_expiredate   date 
,pricemst_maxqty  numeric (22,6)
,pricemst_contract_price  varchar (1) 
