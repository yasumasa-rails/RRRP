 ...
 alter table inamts DROP COLUMN lotno CASCADE;
 ...
 ---- where  pobject_code_sfd = 'lotno'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　lotnoが削除　2019-12-20 00:10:01 +0900' 
 ---- where  pobject_code_sfd = 'lotno'
 alter table inamts DROP COLUMN packno CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'packno'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　packnoが削除　2019-12-20 00:10:01 +0900' 
 ---- where  pobject_code_sfd = 'packno'
 alter table inamts DROP COLUMN locas_id_out CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　locas_id_outが削除　2019-12-20 00:10:01 +0900' 
 ---- where  pobject_code_sfd = 'locas_id_out'
