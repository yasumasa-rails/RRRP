 ...
 alter table mkords DROP COLUMN itm_code_org CASCADE;
 ...
 ---- where  pobject_code_sfd = 'itm_code_org'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　itm_code_orgが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'itm_code_org'
 alter table mkords DROP COLUMN itm_name_org CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'itm_name_org'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　itm_name_orgが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'itm_name_org'
 alter table mkords DROP COLUMN loca_code_org CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'loca_code_org'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　loca_code_orgが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'loca_code_org'
 alter table mkords DROP COLUMN loca_name_org CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'loca_name_org'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　loca_name_orgが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'loca_name_org'
 alter table mkords DROP COLUMN itm_code_pare CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'itm_code_pare'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　itm_code_pareが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'itm_code_pare'
 alter table mkords DROP COLUMN itm_name_pare CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'itm_name_pare'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　itm_name_pareが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'itm_name_pare'
 alter table mkords DROP COLUMN loca_name_pare CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'loca_name_pare'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　loca_name_pareが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'loca_name_pare'
 alter table mkords DROP COLUMN loca_code_pare CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'loca_code_pare'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　loca_code_pareが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'loca_code_pare'
 alter table mkords DROP COLUMN itm_code_trn CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'itm_code_trn'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　itm_code_trnが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'itm_code_trn'
 alter table mkords DROP COLUMN itm_name_trn CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'itm_name_trn'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　itm_name_trnが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'itm_name_trn'
 alter table mkords DROP COLUMN loca_code_trn CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'loca_code_trn'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　loca_code_trnが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'loca_code_trn'
 alter table mkords DROP COLUMN loca_name_trn CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'loca_name_trn'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　loca_name_trnが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'loca_name_trn'
 alter table mkords DROP COLUMN loca_code_to_trn CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'loca_code_to_trn'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　loca_code_to_trnが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'loca_code_to_trn'
 alter table mkords DROP COLUMN loca_name_to_trn CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'loca_name_to_trn'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　loca_name_to_trnが削除　2020-04-24 23:26:23 +0900' 
 ---- where  pobject_code_sfd = 'loca_name_to_trn'
 alter table  mkords  ADD COLUMN locas_id_to numeric(38,0);

 alter table  mkords  ADD COLUMN locas_id_trn numeric(38,0);

 alter table  mkords  ADD COLUMN itms_id_org numeric(38,0);

 alter table  mkords  ADD COLUMN itms_id_trn numeric(38,0);

 alter table  mkords  ADD COLUMN locas_id_org numeric(38,0);

 alter table  mkords  ADD COLUMN locas_id_pare numeric(38,0);

 alter table  mkords  ADD COLUMN itms_id_pare numeric(38,0);

 ALTER TABLE mkords ADD CONSTRAINT mkord_locas_id_to FOREIGN KEY (locas_id_to)
																		 REFERENCES locas (id);
 ALTER TABLE mkords ADD CONSTRAINT mkord_locas_id_trn FOREIGN KEY (locas_id_trn)
																		 REFERENCES locas (id);
 ALTER TABLE mkords ADD CONSTRAINT mkord_itms_id_org FOREIGN KEY (itms_id_org)
																		 REFERENCES itms (id);
 ALTER TABLE mkords ADD CONSTRAINT mkord_itms_id_trn FOREIGN KEY (itms_id_trn)
																		 REFERENCES itms (id);
 ALTER TABLE mkords ADD CONSTRAINT mkord_locas_id_org FOREIGN KEY (locas_id_org)
																		 REFERENCES locas (id);
 ALTER TABLE mkords ADD CONSTRAINT mkord_locas_id_pare FOREIGN KEY (locas_id_pare)
																		 REFERENCES locas (id);
 ALTER TABLE mkords ADD CONSTRAINT mkord_itms_id_pare FOREIGN KEY (itms_id_pare)
																		 REFERENCES itms (id);
...
mkord.paretblname  mkord_paretblname
 from mkords   mkord,
  r_persons  person_upd ,  r_chrgs  chrg_trn ,  r_itms  itm_org ,  r_itms  itm_pare ,  r_itms  itm_trn ,  r_locas  loca_org ,  r_locas  loca_pare ,  r_locas  loca_trn ,  r_locas  loca_to 
  where       mkord.persons_id_upd = person_upd.id      and mkord.chrgs_id_trn = chrg_trn.id      and mkord.itms_id_org = itm_org.id      and mkord.itms_id_pare = itm_pare.id      and mkord.itms_id_trn = itm_trn.id      and mkord.locas_id_org = loca_org.id      and mkord.locas_id_pare = loca_pare.id      and mkord.locas_id_trn = loca_trn.id      and mkord.locas_id_to = loca_to.id     ;
