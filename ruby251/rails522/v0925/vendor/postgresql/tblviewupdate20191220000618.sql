 ...
 alter table instks DROP COLUMN locas_id_out CASCADE;
 ...
 ---- where  pobject_code_sfd = 'locas_id_out'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　locas_id_outが削除　2019-12-20 00:06:15 +0900' 
 ---- where  pobject_code_sfd = 'locas_id_out'
...
instk.locas_id_in   instk_loca_id_in,
instk.locas_id_out   instk_loca_id_out,
 ...
 from instks   instk,
  ...
  where       instk.persons_id_upd = person_upd.id      and instk.trngantts_id = trngantt.id      and instk.locas_id_in = loca_in.id      and instk.locas_id_out = loca_out.id     ;
