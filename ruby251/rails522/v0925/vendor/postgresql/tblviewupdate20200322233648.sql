 ...
 alter table  trngantts ALTER COLUMN qty  TYPE numeric(22,6);

 alter table  trngantts ALTER COLUMN qty_alloc  TYPE numeric(22,6);

 alter table  trngantts ALTER COLUMN qty_stk  TYPE numeric(22,6);
