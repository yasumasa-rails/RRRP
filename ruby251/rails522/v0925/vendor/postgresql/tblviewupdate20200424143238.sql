 ...
 alter table mkords DROP COLUMN tblname_pare CASCADE;
 ...
 ---- where  pobject_code_sfd = 'tblname_pare'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　tblname_pareが削除　2020-04-24 14:32:36 +0900' 
 ---- where  pobject_code_sfd = 'tblname_pare'
 alter table mkords  ADD COLUMN paretblname varchar(30);
