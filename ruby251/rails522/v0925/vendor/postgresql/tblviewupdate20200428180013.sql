 ...
 locas_id_workplace numeric(22,0 )   not null ,
 chrgs_id_workplace numeric(22,0 )   not null ,
 ...
 created_at timestamp(6)  ,
  CONSTRAINT workplaces_id_pk PRIMARY KEY (id));
 ALTER TABLE workplaces ADD CONSTRAINT workplace_locas_id_workplace FOREIGN KEY (locas_id_workplace)
																		 REFERENCES locas (id);
 ALTER TABLE workplaces ADD CONSTRAINT workplace_chrgs_id_workplace FOREIGN KEY (chrgs_id_workplace)
																		 REFERENCES chrgs (id);
 ALTER TABLE workplaces ADD CONSTRAINT workplace_persons_id_upd FOREIGN KEY (persons_id_upd)
