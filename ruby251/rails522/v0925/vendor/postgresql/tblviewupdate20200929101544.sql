 ...
 alter table mkords DROP COLUMN duedate_trn CASCADE;
 ...
 ---- where  pobject_code_sfd = 'duedate_trn'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　duedate_trnが削除　2020-09-29 10:15:43 +0900' 
 ---- where  pobject_code_sfd = 'duedate_trn'
 alter table mkords  ADD COLUMN duedate_trn timestamp(6);

 alter table mkords DROP COLUMN duedate_pare CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'duedate_pare'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　duedate_pareが削除　2020-09-29 10:15:43 +0900' 
 ---- where  pobject_code_sfd = 'duedate_pare'
 alter table mkords  ADD COLUMN duedate_pare timestamp(6);
