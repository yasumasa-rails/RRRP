 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　trngantts_idが削除　2020-04-06 22:24:22 +0900' 
 ---- where  pobject_code_sfd = 'trngantts_id'
 alter table  inamts  ADD COLUMN alloctbls_id numeric(38,0);

 alter table incustwhs DROP COLUMN trngantts_id CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'trngantts_id'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　trngantts_idが削除　2020-04-06 22:24:23 +0900' 
 ---- where  pobject_code_sfd = 'trngantts_id'
 alter table  incustwhs  ADD COLUMN alloctbls_id numeric(38,0);

 alter table instks DROP COLUMN trngantts_id CASCADE;
 ...
 alter table outstks DROP COLUMN trngantts_id CASCADE;
