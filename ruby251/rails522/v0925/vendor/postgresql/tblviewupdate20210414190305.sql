 ...
 alter table payords DROP COLUMN gno CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gnoが削除　2021-04-14 19:03:02 +0900' 
 ---- where  pobject_code_sfd = 'gno'
 alter table mkords DROP COLUMN gno_trn CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'gno_trn'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gno_trnが削除　2021-04-14 19:03:02 +0900' 
 ---- where  pobject_code_sfd = 'gno_trn'
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gno_prdschが削除　2021-04-14 19:03:02 +0900' 
 ---- where  pobject_code_sfd = 'gno_prdsch'
 alter table prdords DROP COLUMN cno CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'cno'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　cnoが削除　2021-04-14 19:03:02 +0900' 
 ---- where  pobject_code_sfd = 'cno'
 alter table purords DROP COLUMN gno_pursch CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'gno_pursch'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gno_purschが削除　2021-04-14 19:03:02 +0900' 
 ---- where  pobject_code_sfd = 'gno_pursch'
 alter table purords DROP COLUMN cno CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　cnoが削除　2021-04-14 19:03:02 +0900' 
 ---- where  pobject_code_sfd = 'cno'
 alter table shpords  ADD COLUMN gno_shpsch varchar(50);

 alter table custords DROP COLUMN gno_custsch CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'gno_custsch'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gno_custschが削除　2021-04-14 19:03:02 +0900' 
 ---- where  pobject_code_sfd = 'gno_custsch'
...
,billord_tblid  numeric (22,0)
,billord_tax  numeric (22,0)
,billord_saledate   timestamp(6) 
,billord_remark  varchar (4000) 
,billord_expiredate   date 
,itm_name  varchar (100) 
,billord_orgtblid  numeric (22,0)
,billord_price  numeric (22,0)
,itm_code  varchar (50) 
