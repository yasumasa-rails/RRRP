 ...
 alter table prdords DROP COLUMN locas_id_to CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　locas_id_toが削除　2020-03-07 12:58:48 +0900' 
 ---- where  pobject_code_sfd = 'locas_id_to'
 alter table prdords DROP COLUMN processseq_pare CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'processseq_pare'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　processseq_pareが削除　2020-03-07 12:58:48 +0900' 
 ---- where  pobject_code_sfd = 'processseq_pare'
 alter table  prdords  ADD COLUMN shelfnos_id_to numeric(38,0);

 ALTER TABLE prdords ADD CONSTRAINT prdord_shelfnos_id_to FOREIGN KEY (shelfnos_id_to)
