 ...
 starttime_trn varchar(18)   ,
 duedate_trn varchar(18)   ,
 itm_code_trn varchar(50)   ,
 itm_name_trn varchar(100)   ,
 opeitm_processseq_trn char(3)   ,
 loca_code_trn varchar(50)   ,
 loca_name_trn varchar(100)   ,
 loca_code_to_trn varchar(50)   ,
 ...
 updated_at timestamp(6)  ,
  CONSTRAINT mkords_id_pk PRIMARY KEY (id));
 ALTER TABLE mkords ADD CONSTRAINT mkord_persons_id_upd FOREIGN KEY (persons_id_upd)
																		 REFERENCES persons (id);
 create sequence mkords_seq ;
...
,mkord_person_code_chrg_trn  varchar (0) 
,mkord_person_name_chrg_trn  varchar (0) 
