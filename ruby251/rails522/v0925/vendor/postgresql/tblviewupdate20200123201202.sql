 ...
 alter table custords DROP COLUMN locas_id_to CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　locas_id_toが削除　2020-01-23 20:11:58 +0900' 
 ---- where  pobject_code_sfd = 'locas_id_to'
 alter table  custords  ADD COLUMN custrcvplcs_id numeric(38,0);

 ALTER TABLE custords ADD CONSTRAINT custord_custrcvplcs_id FOREIGN KEY (custrcvplcs_id)
