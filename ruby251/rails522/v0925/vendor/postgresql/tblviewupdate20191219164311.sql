...
purord.persons_id_upd   purord_person_id_upd,
 ...
 from purords   purord,
  r_locas  loca_to ,  r_prjnos  prjno ,  r_opeitms  opeitm ,  r_chrgs  chrg ,  r_suppliers  supplier ,  r_crrs  crr_pur ,  r_persons  person_upd 
  where       purord.locas_id_to = loca_to.id      and purord.prjnos_id = prjno.id      and purord.opeitms_id = opeitm.id      and purord.chrgs_id = chrg.id      and purord.suppliers_id = supplier.id      and purord.crrs_id_pur = crr_pur.id      and purord.persons_id_upd = person_upd.id     ;
