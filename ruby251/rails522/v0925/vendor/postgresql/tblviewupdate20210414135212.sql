 ...
 alter table  billschs  ADD COLUMN amt_sch numeric(38,4) ;

 alter table billschs DROP COLUMN amt CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　amtが削除　2021-04-14 13:52:10 +0900' 
 ---- where  pobject_code_sfd = 'amt'
 alter table billschs DROP COLUMN tblname CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　tblnameが削除　2021-04-14 13:52:10 +0900' 
 ---- where  pobject_code_sfd = 'tblname'
 alter table billschs DROP COLUMN tblid CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　tblidが削除　2021-04-14 13:52:10 +0900' 
 ---- where  pobject_code_sfd = 'tblid'
 alter table  payschs  ADD COLUMN amt_sch numeric(38,4) ;

 alter table payschs DROP COLUMN amt CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　amtが削除　2021-04-14 13:52:10 +0900' 
 ---- where  pobject_code_sfd = 'amt'
 alter table payschs DROP COLUMN crrs_id_pur CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'crrs_id_pur'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　crrs_id_purが削除　2021-04-14 13:52:10 +0900' 
 ---- where  pobject_code_sfd = 'crrs_id_pur'
 alter table  custschs  ADD COLUMN amt_sch numeric(38,4) ;

 alter table custschs DROP COLUMN amt CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　amtが削除　2021-04-14 13:52:10 +0900' 
 ---- where  pobject_code_sfd = 'amt'
 alter table custschs DROP COLUMN gno CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gnoが削除　2021-04-14 13:52:10 +0900' 
 ---- where  pobject_code_sfd = 'gno'
 alter table prdschs DROP COLUMN gno CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gnoが削除　2021-04-14 13:52:10 +0900' 
 ---- where  pobject_code_sfd = 'gno'
 alter table  purschs  ADD COLUMN amt_sch numeric(38,4) ;

 alter table purschs DROP COLUMN amt CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　amtが削除　2021-04-14 13:52:10 +0900' 
 ---- where  pobject_code_sfd = 'amt'
 alter table purschs DROP COLUMN gno CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gnoが削除　2021-04-14 13:52:10 +0900' 
 ---- where  pobject_code_sfd = 'gno'
 alter table  shpschs  ADD COLUMN amt_sch numeric(38,4) ;

 alter table shpschs DROP COLUMN amt CASCADE;
...
,custsch_cno  varchar (40) 
,custsch_isudate   timestamp 
,custsch_expiredate   date 
,itm_code  varchar (50) 
,itm_name  varchar (100) 
,custsch_duedate   timestamp 
,opeitm_packqty  numeric (38,0)
,opeitm_duration  numeric (38,2)
,custsch_qty  numeric (38,4)
,custsch_qty_src  numeric (38,4)
,custsch_price  numeric (38,4)
,custsch_amt  numeric (38,4)
,custsch_sno  varchar (40) 
,custsch_qty_sch  numeric (22,6)
,custsch_amt_sch  numeric (38,4)
,custsch_contract_price  varchar (0) 
...
,cust_tel  varchar (20) 
,itm_std  varchar (50) 
,cust_rule_price  varchar (0) 
,cust_contract_price  varchar (0) 
,custsch_cust_id  numeric (38,0)
...
,custsch_update_ip  varchar (0) 
,custsch_created_at   timestamp 
,custsch_itm_id  numeric (38,0)
,custsch_updated_at   timestamp 
,custsch_prjno_id  numeric (38,0)
,person_name_upd  varchar (100) 
          ,sio_errline varchar(4000)
          ,sio_org_tblname varchar(30)
