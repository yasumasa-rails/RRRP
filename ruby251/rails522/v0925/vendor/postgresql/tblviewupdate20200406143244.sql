 ...
 alter table alloctbls DROP COLUMN destblname CASCADE;
 ...
 ---- where  pobject_code_sfd = 'destblname'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　destblnameが削除　2020-04-06 14:32:42 +0900' 
 ---- where  pobject_code_sfd = 'destblname'
 alter table alloctbls DROP COLUMN destblid CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'destblid'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　destblidが削除　2020-04-06 14:32:42 +0900' 
 ---- where  pobject_code_sfd = 'destblid'
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　packqtyが削除　2020-04-06 14:32:42 +0900' 
 ---- where  pobject_code_sfd = 'packqty'
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　amtが削除　2020-04-06 14:32:42 +0900' 
 ---- where  pobject_code_sfd = 'amt'
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　shuffle_flgが削除　2020-04-06 14:32:42 +0900' 
 ---- where  pobject_code_sfd = 'shuffle_flg'
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　allocfreeが削除　2020-04-06 14:32:42 +0900' 
 ---- where  pobject_code_sfd = 'allocfree'
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　allocfreeidが削除　2020-04-06 14:32:42 +0900' 
 ---- where  pobject_code_sfd = 'allocfreeid'
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　shuffle_locaが削除　2020-04-06 14:32:42 +0900' 
 ---- where  pobject_code_sfd = 'shuffle_loca'
 alter table  alloctbls ALTER COLUMN qty  TYPE numeric(22,6);

 alter table  alloctbls ALTER COLUMN qty_stk  TYPE numeric(22,6);

 alter table  alloctbls  ADD COLUMN trngantts_id numeric(38,0);

 ALTER TABLE alloctbls ADD CONSTRAINT alloctbl_trngantts_id FOREIGN KEY (trngantts_id)
