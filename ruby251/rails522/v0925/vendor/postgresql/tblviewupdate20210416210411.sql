 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　itms_idが削除　2021-04-16 21:04:08 +0900' 
 ---- where  pobject_code_sfd = 'itms_id'
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　replydateが削除　2021-04-16 21:04:08 +0900' 
 ---- where  pobject_code_sfd = 'replydate'
 alter table purrets  ADD COLUMN sno_puract varchar(50);

 alter table prdrets  ADD COLUMN sno_prdact varchar(50);
...
prdret.opeitms_id   prdret_opeitm_id,
  .opeitm_opt_fix_flg  opeitm_opt_fix_flg ,
  .opeitm_prjalloc_flg  opeitm_prjalloc_flg ,
  .prjno_code_chil  prjno_code_chil ,
