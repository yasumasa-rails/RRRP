 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　consumtypeが削除　2020-05-02 21:11:08 +0900' 
 ---- where  pobject_code_sfd = 'consumtype'
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'consumtype'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　consumtypeが削除　2020-05-02 21:11:09 +0900' 
 ---- where  pobject_code_sfd = 'consumtype'
