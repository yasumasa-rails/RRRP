 ...
 alter table  shpacts  ADD COLUMN processseq numeric(38,0) ;

 alter table shpacts  ADD COLUMN sno_shpord varchar(50);

 alter table shpacts  ADD COLUMN gno_shpord varchar(50);
