...
payment.personname  payment_personname
 from payments   payment,
  r_persons  person_upd ,  r_locas  loca_payment ,  r_chrgs  chrg_payment 
  where       payment.persons_id_upd = person_upd.id      and payment.locas_id_payment = loca_payment.id      and payment.chrgs_id_payment = chrg_payment.id     ;
