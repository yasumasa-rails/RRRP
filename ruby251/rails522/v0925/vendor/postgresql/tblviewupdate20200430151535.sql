 ...
 ALTER TABLE shpords ADD CONSTRAINT shpord_itms_id FOREIGN KEY (itms_id)
																		 REFERENCES itms (id);
 ALTER TABLE shpords ADD CONSTRAINT shpord_shelfnos_id_fm FOREIGN KEY (shelfnos_id_fm)
																		 REFERENCES shelfnos (id);
 ALTER TABLE shpords ADD CONSTRAINT shpord_locas_id_to FOREIGN KEY (locas_id_to)
																		 REFERENCES locas (id);
 ALTER TABLE shpords ADD CONSTRAINT shpord_transports_id FOREIGN KEY (transports_id)
																		 REFERENCES transports (id);
 ALTER TABLE shpords ADD CONSTRAINT shpord_prjnos_id FOREIGN KEY (prjnos_id)
																		 REFERENCES prjnos (id);
 ALTER TABLE shpords ADD CONSTRAINT shpord_chrgs_id FOREIGN KEY (chrgs_id)
																		 REFERENCES chrgs (id);
 ALTER TABLE shpords ADD CONSTRAINT shpord_crrs_id FOREIGN KEY (crrs_id)
																		 REFERENCES crrs (id);
 ALTER TABLE shpords ADD CONSTRAINT shpord_persons_id_upd FOREIGN KEY (persons_id_upd)
