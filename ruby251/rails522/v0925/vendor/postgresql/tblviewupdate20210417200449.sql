...
shpret.crrs_id   shpret_crr_id,
  prjno.prjno_name_chil  prjno_name_chil 
 from shprets   shpret,
  r_persons  person_upd ,  r_chrgs  chrg ,  r_prjnos  prjno ,  r_locas  loca_fm ,  r_locas  loca_to ,  r_crrs  crr 
  where       shpret.persons_id_upd = person_upd.id      and shpret.chrgs_id = chrg.id      and shpret.prjnos_id = prjno.id      and shpret.locas_id_fm = loca_fm.id      and shpret.locas_id_to = loca_to.id      and shpret.crrs_id = crr.id     ;
