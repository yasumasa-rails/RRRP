 ...
 alter table billords  ADD COLUMN gno_billsch varchar(40);

 alter table payords  ADD COLUMN gno_paysch varchar(40);

 alter table payords  ADD COLUMN gno varchar(40);

 alter table prdords  ADD COLUMN gno_prdsch varchar(50);

 alter table purords  ADD COLUMN gno_pursch varchar(50);

 alter table custords  ADD COLUMN gno_custsch varchar(50);
