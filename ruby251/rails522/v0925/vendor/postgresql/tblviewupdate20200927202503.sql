 ...
 alter table mkords DROP COLUMN chrgs_id_trn CASCADE;
 ...
 ---- where  pobject_code_sfd = 'chrgs_id_trn'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　chrgs_id_trnが削除　2020-09-27 20:25:02 +0900' 
 ---- where  pobject_code_sfd = 'chrgs_id_trn'
 alter table mkords DROP COLUMN locas_id_trn CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'locas_id_trn'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　locas_id_trnが削除　2020-09-27 20:25:02 +0900' 
 ---- where  pobject_code_sfd = 'locas_id_trn'
 alter table mkords DROP COLUMN locas_id_org CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'locas_id_org'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　locas_id_orgが削除　2020-09-27 20:25:02 +0900' 
 ---- where  pobject_code_sfd = 'locas_id_org'
 alter table mkords DROP COLUMN locas_id_pare CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'locas_id_pare'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　locas_id_pareが削除　2020-09-27 20:25:02 +0900' 
 ---- where  pobject_code_sfd = 'locas_id_pare'
 alter table mkords  ADD COLUMN loca_code_org varchar(50);

 alter table mkords  ADD COLUMN person_code_chrg_trn varchar(50);

 alter table mkords  ADD COLUMN loca_code_pare varchar(50);

 alter table mkords  ADD COLUMN loca_code_trn varchar(50);

 alter table mkords  ADD COLUMN loca_code_to_trn varchar(50);
...
mkord.paretblname  mkord_paretblname
 from mkords   mkord,
  r_persons  person_upd ,  r_chrgs  chrg_trn ,  r_itms  itm_trn ,  r_itms  itm_pare ,  r_itms  itm_org ,  r_locas  loca_trn ,  r_locas  loca_pare ,  r_locas  loca_org 
  where       mkord.persons_id_upd = person_upd.id      and mkord.chrgs_id_trn = chrg_trn.id      and mkord.itms_id_trn = itm_trn.id      and mkord.itms_id_pare = itm_pare.id      and mkord.itms_id_org = itm_org.id      and mkord.locas_id_trn = loca_trn.id      and mkord.locas_id_pare = loca_pare.id      and mkord.locas_id_org = loca_org.id     ;
