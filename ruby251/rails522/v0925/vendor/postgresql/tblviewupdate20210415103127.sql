 ...
 alter table billinsts DROP COLUMN gno CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gnoが削除　2021-04-15 10:31:19 +0900' 
 ---- where  pobject_code_sfd = 'gno'
 alter table payinsts DROP COLUMN gno CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gnoが削除　2021-04-15 10:31:19 +0900' 
 ---- where  pobject_code_sfd = 'gno'
 alter table payinsts DROP COLUMN gno_payord CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'gno_payord'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gno_payordが削除　2021-04-15 10:31:19 +0900' 
 ---- where  pobject_code_sfd = 'gno_payord'
 alter table prdinsts DROP COLUMN cno_prdord CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　cno_prdordが削除　2021-04-15 10:31:19 +0900' 
 ---- where  pobject_code_sfd = 'cno_prdord'
 alter table purinsts DROP COLUMN gno CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gnoが削除　2021-04-15 10:31:19 +0900' 
 ---- where  pobject_code_sfd = 'gno'
 alter table shpinsts  ADD COLUMN gno_shpord varchar(50);

 alter table  custinsts  ADD COLUMN opeitms_id numeric(38,0)  DEFAULT 0  not null;

 alter table custinsts DROP COLUMN itms_id CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　itms_idが削除　2021-04-15 10:31:19 +0900' 
 ---- where  pobject_code_sfd = 'itms_id'
...
,billinst_tblid  numeric (22,0)
,billinst_tax  numeric (22,0)
,billinst_orgtblname  varchar (30) 
,billinst_orgtblid  numeric (22,0)
,billinst_expiredate   date 
,billinst_saledate   timestamp(6) 
,billinst_remark  varchar (4000) 
,billinst_qty  numeric (18,4)
,billinst_price  numeric (22,0)
...
custinst.custrcvplcs_id   custinst_custrcvplc_id,
  ...
  .loca_code_sect_asstwh  loca_code_sect_asstwh ,
  .loca_name_sect_asstwh  loca_name_sect_asstwh ,
  opeitm.boxe_unit_id_box  boxe_unit_id_box ,
  opeitm.unit_code_box  unit_code_box ,
  opeitm.unit_name_box  unit_name_box ,
  opeitm.boxe_unit_id_outbox  boxe_unit_id_outbox ,
