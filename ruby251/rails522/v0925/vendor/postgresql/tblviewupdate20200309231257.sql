 ...
 alter table  nditms  ADD COLUMN price numeric(38,4);

 alter table  nditms  ADD COLUMN crrs_id numeric(22,0);

 ALTER TABLE nditms ADD CONSTRAINT nditm_crrs_id FOREIGN KEY (crrs_id)
																		 REFERENCES crrs (id);
