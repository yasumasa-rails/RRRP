 ...
 alter table  prdords  ADD COLUMN crrs_id_prdord numeric(22,0)  DEFAULT 0  not null;

 alter table  billords  ADD COLUMN crrs_id_billord numeric(22,0)  DEFAULT 0  not null;

 alter table  purords  ADD COLUMN crrs_id_purord numeric(22,0)  DEFAULT 0  not null;

 alter table purords DROP COLUMN crrs_id_pur CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　crrs_id_purが削除　2021-05-02 16:06:54 +0900' 
 ---- where  pobject_code_sfd = 'crrs_id_pur'
 alter table purords DROP COLUMN crrs_id CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'crrs_id'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　crrs_idが削除　2021-05-02 16:06:54 +0900' 
 ---- where  pobject_code_sfd = 'crrs_id'
 alter table  shpords  ADD COLUMN crrs_id_shpord numeric(22,0)  DEFAULT 0  not null;

 alter table shpords DROP COLUMN crrs_id CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　crrs_idが削除　2021-05-02 16:06:54 +0900' 
 ---- where  pobject_code_sfd = 'crrs_id'
 alter table  payords  ADD COLUMN crrs_id_payord numeric(22,0)  DEFAULT 0  not null;

 alter table payords DROP COLUMN crrs_id_pur CASCADE;
...
,supplier_crr_id_supplier  numeric (22,0)
 ...
 ALTER TABLE prdords ADD CONSTRAINT prdord_crrs_id_prdord FOREIGN KEY (crrs_id_prdord)
																		 REFERENCES crrs (id);
 ALTER TABLE billords ADD CONSTRAINT billord_crrs_id_billord FOREIGN KEY (crrs_id_billord)
																		 REFERENCES crrs (id);
 ALTER TABLE purords ADD CONSTRAINT purord_crrs_id_purord FOREIGN KEY (crrs_id_purord)
																		 REFERENCES crrs (id);
 ALTER TABLE shpords ADD CONSTRAINT shpord_crrs_id_shpord FOREIGN KEY (crrs_id_shpord)
																		 REFERENCES crrs (id);
 ALTER TABLE payords ADD CONSTRAINT payord_crrs_id_payord FOREIGN KEY (crrs_id_payord)
																		 REFERENCES crrs (id);
