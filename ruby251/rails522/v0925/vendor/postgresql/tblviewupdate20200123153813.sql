 ...
 opeitms_id numeric(38,0 )   not null ,
  CONSTRAINT custschs_id_pk PRIMARY KEY (id));
 ALTER TABLE custschs ADD CONSTRAINT custsch_persons_id_upd FOREIGN KEY (persons_id_upd)
																		 REFERENCES persons (id);
 ALTER TABLE custschs ADD CONSTRAINT custsch_prjnos_id FOREIGN KEY (prjnos_id)
																		 REFERENCES prjnos (id);
 ALTER TABLE custschs ADD CONSTRAINT custsch_custs_id FOREIGN KEY (custs_id)
																		 REFERENCES custs (id);
 ALTER TABLE custschs ADD CONSTRAINT custsch_opeitms_id FOREIGN KEY (opeitms_id)
																		 REFERENCES opeitms (id);
 create sequence custschs_seq ;
