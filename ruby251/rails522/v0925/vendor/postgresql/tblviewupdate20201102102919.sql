 ...
 alter table trngantts DROP COLUMN duedate_org CASCADE;
 ...
 ---- where  pobject_code_sfd = 'duedate_org'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　duedate_orgが削除　2020-11-02 10:28:28 +0900' 
 ---- where  pobject_code_sfd = 'duedate_org'
 alter table  trngantts  ADD COLUMN qty_bal numeric(22,6) ;

 alter table  trngantts  ADD COLUMN qty_pare_bal numeric(22,6) ;
