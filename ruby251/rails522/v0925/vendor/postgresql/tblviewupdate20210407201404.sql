...
,chrg_person_id_chrg_supplier  numeric (38,0)
 ...
 ALTER TABLE custs ADD CONSTRAINT cust_crrs_id_cust FOREIGN KEY (crrs_id_cust)
																		 REFERENCES crrs (id);
 ALTER TABLE payments ADD CONSTRAINT payment_crrs_id_payment FOREIGN KEY (crrs_id_payment)
																		 REFERENCES crrs (id);
