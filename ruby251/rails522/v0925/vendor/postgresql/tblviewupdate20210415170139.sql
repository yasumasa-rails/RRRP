...
prjno.code_chil_chil  prjno_code_chil_chil,
prjno.prjnos_id_chil_chil   prjno_prjno_id_chil_chil
 from prjnos   prjno,
  r_prjnos  prjno_chil ,  r_prjnos  prjno_chil_chil 
  where       prjno.prjnos_id_chil = prjno_chil.id      and prjno.prjnos_id_chil = prjno_chil_chil.id     ;
...
,prjno_code_chil_chil  varchar (50) 
,prjno_name_chil  varchar (100) 
,prjno_prjno_id_chil_chil  numeric (38,0)
