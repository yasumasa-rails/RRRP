 ...
 alter table alloctbls DROP COLUMN qty_alloc CASCADE;
 ...
 ---- where  pobject_code_sfd = 'qty_alloc'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　qty_allocが削除　2020-04-14 15:43:23 +0900' 
 ---- where  pobject_code_sfd = 'qty_alloc'
