 ...
 alter table  shpschs ALTER COLUMN qty  TYPE numeric(22,6);

 alter table  shpschs ALTER COLUMN qty_stk  TYPE numeric(22,6);

 alter table  shpschs ALTER COLUMN qty_case  TYPE numeric(22,0);
