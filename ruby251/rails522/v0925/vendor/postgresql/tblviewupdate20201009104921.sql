...
mkordopeitm.shelfnos_id_to   mkordopeitm_shelfno_id_to,
 ...
 from mkordopeitms   mkordopeitm,
  r_persons  person_upd ,  r_mkords  mkord ,  r_locas  loca ,  r_prjnos  prjno ,  r_shelfnos  shelfno_to 
  where       mkordopeitm.persons_id_upd = person_upd.id      and mkordopeitm.mkords_id = mkord.id      and mkordopeitm.locas_id = loca.id      and mkordopeitm.prjnos_id = prjno.id      and mkordopeitm.shelfnos_id_to = shelfno_to.id     ;
