 ...
 alter table puracts DROP COLUMN shelfnos_id_act CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　shelfnos_id_actが削除　2020-01-22 19:52:37 +0900' 
 ---- where  pobject_code_sfd = 'shelfnos_id_act'
 alter table puracts DROP COLUMN shelfname CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　shelfnameが削除　2020-01-22 19:52:37 +0900' 
 ---- where  pobject_code_sfd = 'shelfname'
 alter table  puracts  ADD COLUMN shelfnos_id_in numeric(38,0);

 alter table  puracts  ADD COLUMN shelfnos_id_to numeric(38,0);

 ALTER TABLE puracts ADD CONSTRAINT puract_shelfnos_id_in FOREIGN KEY (shelfnos_id_in)
																		 REFERENCES shelfnos (id);
 ALTER TABLE puracts ADD CONSTRAINT puract_shelfnos_id_to FOREIGN KEY (shelfnos_id_to)
																		 REFERENCES shelfnos (id);
...
puract.shelfnos_id_in   puract_shelfno_id_in,
...
puract.price  puract_price,
 ...
 from puracts   puract,
  r_chrgs  chrg ,  r_prjnos  prjno ,  r_suppliers  supplier ,  r_shelfnos  shelfno_in ,  r_shelfnos  shelfno_act ,  r_crrs  crr_pur ,  r_shelfnos  shelfno_to ,  r_locas  loca_to ,  r_persons  person_upd ,  r_opeitms  opeitm 
  where       puract.chrgs_id = chrg.id      and puract.prjnos_id = prjno.id      and puract.suppliers_id = supplier.id      and puract.shelfnos_id_in = shelfno_in.id      and puract.shelfnos_id_act = shelfno_act.id      and puract.crrs_id_pur = crr_pur.id      and puract.shelfnos_id_to = shelfno_to.id      and puract.locas_id_to = loca_to.id      and puract.persons_id_upd = person_upd.id      and puract.opeitms_id = opeitm.id     ;
...
,puract_shelfno_id_in  numeric (38,0)
