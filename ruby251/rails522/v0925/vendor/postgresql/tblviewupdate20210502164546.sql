 ...
 alter table custschs  ADD COLUMN gno varchar(40);

 alter table prdschs  ADD COLUMN gno varchar(40);

 alter table purschs  ADD COLUMN gno varchar(40);

 alter table shpschs  ADD COLUMN gno varchar(40);
