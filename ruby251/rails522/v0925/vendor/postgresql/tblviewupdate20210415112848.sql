 ...
 alter table  alloctbls  ADD COLUMN lotstkhists_id_alloctbl numeric(22,0)  DEFAULT 0  not null;

 alter table alloctbls DROP COLUMN lotstkhists_id CASCADE;
 ...
 ---- where  pobject_code_sfd = 'lotstkhists_id'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　lotstkhists_idが削除　2021-04-15 11:28:48 +0900' 
 ---- where  pobject_code_sfd = 'lotstkhists_id'
