...
cust.autocreate_custact  cust_autocreate_custact,
 ...
 from custs   cust,
  r_persons  person_upd ,  r_locas  loca_cust ,  r_chrgs  chrg_cust ,  r_bills  bill 
  where       cust.persons_id_upd = person_upd.id      and cust.locas_id_cust = loca_cust.id      and cust.chrgs_id_cust = chrg_cust.id      and cust.bills_id = bill.id     ;
