 ...
 alter table alloctbls DROP COLUMN qty CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　qtyが削除　2020-04-06 15:16:34 +0900' 
 ---- where  pobject_code_sfd = 'qty'
 alter table alloctbls DROP COLUMN qty_stk CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'qty_stk'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　qty_stkが削除　2020-04-06 15:16:34 +0900' 
 ---- where  pobject_code_sfd = 'qty_stk'
 alter table  alloctbls  ADD COLUMN qty_alloc numeric(22,6);
