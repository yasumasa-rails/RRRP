 ...
 alter table custrcvplcs  ADD COLUMN tel varchar(20);

 alter table custrcvplcs  ADD COLUMN addr1 varchar(50);

 alter table custrcvplcs  ADD COLUMN addr2 varchar(50);
