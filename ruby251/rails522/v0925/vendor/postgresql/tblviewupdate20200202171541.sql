 ...
 alter table custords  ADD COLUMN starttime timestamp(6);
...
custord.update_ip  custord_update_ip,
  ...
  custrcvplc.loca_abbr_custrcvplc  loca_abbr_custrcvplc ,
  ...
  custrcvplc.loca_prfct_custrcvplc  loca_prfct_custrcvplc ,
  opeitm.loca_prfct  loca_prfct ,
  loca_fm.loca_addr1  loca_addr1_fm ,
  custrcvplc.loca_addr1_custrcvplc  loca_addr1_custrcvplc ,
  opeitm.loca_addr1  loca_addr1 ,
  loca_fm.loca_addr2  loca_addr2_fm ,
  custrcvplc.loca_addr2_custrcvplc  loca_addr2_custrcvplc ,
  opeitm.loca_addr2  loca_addr2 ,
  loca_fm.loca_tel  loca_tel_fm ,
  custrcvplc.loca_tel_custrcvplc  loca_tel_custrcvplc ,
...
,custord_cno_custsch  varchar (40) 
