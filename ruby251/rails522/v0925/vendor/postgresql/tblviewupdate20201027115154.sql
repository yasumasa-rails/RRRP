 ...
 alter table shpacts DROP COLUMN shelfnos_id_fm CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　shelfnos_id_fmが削除　2020-10-27 11:51:49 +0900' 
 ---- where  pobject_code_sfd = 'shelfnos_id_fm'
 alter table shpacts DROP COLUMN locas_id_to CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　locas_id_toが削除　2020-10-27 11:51:49 +0900' 
 ---- where  pobject_code_sfd = 'locas_id_to'
 alter table shpacts DROP COLUMN opeitms_id CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　opeitms_idが削除　2020-10-27 11:51:49 +0900' 
 ---- where  pobject_code_sfd = 'opeitms_id'
 alter table  shpacts  ADD COLUMN itms_id numeric(38,0) not null;

 alter table  shpacts  ADD COLUMN instks_id numeric(22,0) not null;

 ALTER TABLE shpacts ADD CONSTRAINT shpact_itms_id FOREIGN KEY (itms_id)
																		 REFERENCES itms (id);
 ALTER TABLE shpacts ADD CONSTRAINT shpact_instks_id FOREIGN KEY (instks_id)
																		 REFERENCES instks (id);
