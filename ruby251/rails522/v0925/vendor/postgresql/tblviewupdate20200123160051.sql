...
bill.personname  bill_personname,
 ...
 from bills   bill,
  r_chrgs  chrg_bill ,  r_persons  person_upd ,  r_locas  loca_bill 
  where       bill.chrgs_id_bill = chrg_bill.id      and bill.persons_id_upd = person_upd.id      and bill.locas_id_bill = loca_bill.id     ;
