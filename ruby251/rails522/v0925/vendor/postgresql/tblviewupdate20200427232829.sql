 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　person_code_chrg_trnが削除　2020-04-27 23:28:26 +0900' 
 ---- where  pobject_code_sfd = 'person_code_chrg_trn'
 alter table mkords DROP COLUMN person_name_chrg_trn CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'person_name_chrg_trn'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　person_name_chrg_trnが削除　2020-04-27 23:28:26 +0900' 
 ---- where  pobject_code_sfd = 'person_name_chrg_trn'
