 ...
 alter table prdschs DROP COLUMN locas_id_to CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　locas_id_toが削除　2020-01-27 12:34:50 +0900' 
 ---- where  pobject_code_sfd = 'locas_id_to'
 alter table  prdschs  ADD COLUMN shelfnos_id_to numeric(38,0);

 ALTER TABLE prdschs ADD CONSTRAINT prdsch_shelfnos_id_to FOREIGN KEY (shelfnos_id_to)
