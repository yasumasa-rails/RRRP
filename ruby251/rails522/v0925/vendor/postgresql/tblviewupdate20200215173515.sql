 ...
 alter table  custrcvplcs ALTER COLUMN custs_id_custrcvplc  TYPE numeric(22,0);

 ALTER TABLE custrcvplcs ADD CONSTRAINT custrcvplc_custs_id_custrcvplc FOREIGN KEY (custs_id_custrcvplc)
																		 REFERENCES custs (id);
