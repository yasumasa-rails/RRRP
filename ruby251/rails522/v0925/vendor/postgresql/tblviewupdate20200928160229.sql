 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　itm_code_trnが削除　2020-09-28 16:02:27 +0900' 
 ---- where  pobject_code_sfd = 'itm_code_trn'
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　itm_code_orgが削除　2020-09-28 16:02:27 +0900' 
 ---- where  pobject_code_sfd = 'itm_code_org'
 alter table mkords DROP COLUMN person_code_chrg_trn CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'person_code_chrg_trn'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　person_code_chrg_trnが削除　2020-09-28 16:02:27 +0900' 
 ---- where  pobject_code_sfd = 'person_code_chrg_trn'
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　loca_code_pareが削除　2020-09-28 16:02:27 +0900' 
 ---- where  pobject_code_sfd = 'loca_code_pare'
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　loca_code_trnが削除　2020-09-28 16:02:27 +0900' 
 ---- where  pobject_code_sfd = 'loca_code_trn'
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　loca_code_to_trnが削除　2020-09-28 16:02:27 +0900' 
 ---- where  pobject_code_sfd = 'loca_code_to_trn'
 ...
 alter table  mkords  ADD COLUMN chrgs_id_trn numeric(38,0);

 alter table  mkords  ADD COLUMN locas_id_pare numeric(38,0);

 alter table  mkords  ADD COLUMN itms_id_pare numeric(38,0);

 alter table mkords DROP COLUMN opeitm_processseq_pare CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'opeitm_processseq_pare'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　opeitm_processseq_pareが削除　2020-09-28 16:02:27 +0900' 
 ---- where  pobject_code_sfd = 'opeitm_processseq_pare'
 alter table mkords  ADD COLUMN opeitm_processseq_pare char(3);

 alter table mkords DROP COLUMN opeitm_processseq_org CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'opeitm_processseq_org'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　opeitm_processseq_orgが削除　2020-09-28 16:02:27 +0900' 
 ---- where  pobject_code_sfd = 'opeitm_processseq_org'
 alter table mkords  ADD COLUMN opeitm_processseq_org char(3);
 ...
 ALTER TABLE mkords ADD CONSTRAINT mkord_locas_id_org FOREIGN KEY (locas_id_org)
																		 REFERENCES locas (id);
 ALTER TABLE mkords ADD CONSTRAINT mkord_chrgs_id_trn FOREIGN KEY (chrgs_id_trn)
																		 REFERENCES chrgs (id);
