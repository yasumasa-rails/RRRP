 ...
 alter table lotstkhists DROP COLUMN locas_id CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　locas_idが削除　2020-01-22 11:23:38 +0900' 
 ---- where  pobject_code_sfd = 'locas_id'
 alter table  lotstkhists  ADD COLUMN shelfnos_id numeric(38,0);

 ALTER TABLE lotstkhists ADD CONSTRAINT lotstkhist_shelfnos_id FOREIGN KEY (shelfnos_id)
