 ...
 alter table  boxes ALTER COLUMN height  TYPE numeric(22,2);

 --- drop view r_boxes cascade  
 create or replace view r_boxes as select  
boxe.code  boxe_code,
boxe.name  boxe_name,
  .unit_code_outbox  unit_code_outbox ,
  .unit_code_box  unit_code_box ,
  .unit_name_outbox  unit_name_outbox ,
  .unit_name_box  unit_name_box ,
boxe.id  boxe_id,
boxe.id id,
