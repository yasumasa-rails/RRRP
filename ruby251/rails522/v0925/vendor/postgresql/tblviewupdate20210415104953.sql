 ...
 alter table prdacts DROP COLUMN cno_prdord CASCADE;
 ...
 ---- where  pobject_code_sfd = 'cno_prdord'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　cno_prdordが削除　2021-04-15 10:49:43 +0900' 
 ---- where  pobject_code_sfd = 'cno_prdord'
 alter table  custacts  ADD COLUMN opeitms_id numeric(38,0)  DEFAULT 0  not null;

 alter table custacts DROP COLUMN itms_id CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　itms_idが削除　2021-04-15 10:49:43 +0900' 
 ---- where  pobject_code_sfd = 'itms_id'
 alter table payacts DROP COLUMN gno CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gnoが削除　2021-04-15 10:49:43 +0900' 
 ---- where  pobject_code_sfd = 'gno'
 alter table puracts DROP COLUMN gno CASCADE;
 ...
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gnoが削除　2021-04-15 10:49:43 +0900' 
 ---- where  pobject_code_sfd = 'gno'
 alter table puracts DROP COLUMN gno_purord CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'gno_purord'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gno_purordが削除　2021-04-15 10:49:43 +0900' 
 ---- where  pobject_code_sfd = 'gno_purord'
 alter table puracts DROP COLUMN gno_purinst CASCADE;
 ...
 --- select * from pobject_code_scr,pobject_code_sfd,
							...
							---	case screenfield_hideflg when 1 then '' else '表示有' end display,
							---   case screenfield_indisp when 1 then '必須' else '' end inquire from r_screenfields 
 ---- where  pobject_code_sfd = 'gno_purinst'
 ---- update screenfields set expiredate ='2000/01/01',remark =' 項目　gno_purinstが削除　2021-04-15 10:49:43 +0900' 
 ---- where  pobject_code_sfd = 'gno_purinst'
 alter table shpacts  ADD COLUMN gno_shpinst varchar(50);
...
,opeitm_loca_id  numeric (38,0)
 ...
 create or replace view r_custacts as select  
  ...
  .loca_code_custrcvplc  loca_code_custrcvplc ,
  .loca_name_custrcvplc  loca_name_custrcvplc ,
custact.id id,
  ...
  .usrgrp_code_chrg_asstwh  usrgrp_code_chrg_asstwh ,
  .usrgrp_name_chrg_asstwh  usrgrp_name_chrg_asstwh ,
...
,chrg_person_id_chrg  numeric (38,0)
 ...
 ALTER TABLE custacts ADD CONSTRAINT custact_opeitms_id FOREIGN KEY (opeitms_id)
