 ...
 alter table  prdschs ALTER COLUMN qty_case  TYPE numeric(22,0);

 alter table  prdschs  ADD COLUMN workplaces_id numeric(22,0);

 ALTER TABLE prdschs ADD CONSTRAINT prdsch_workplaces_id FOREIGN KEY (workplaces_id)
