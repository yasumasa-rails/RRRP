 ...
 create table custrcvplcs (
 id numeric(38,0 )   not null  ,
 locas_id_custrcvplc numeric(38,0 )   not null ,
 ...
 ALTER TABLE custrcvplcs ADD CONSTRAINT custrcvplc_locas_id_custrcvplc FOREIGN KEY (locas_id_custrcvplc)
																		 REFERENCES locas (id);
 ALTER TABLE custrcvplcs ADD CONSTRAINT custrcvplc_persons_id_upd FOREIGN KEY (persons_id_upd)
																		 REFERENCES persons (id);
 create sequence custrcvplcs_seq ;
 --- drop view r_custrcvplcs cascade  
 create or replace view r_custrcvplcs as select  
custrcvplc.autoord_p  custrcvplc_autoord_p,
custrcvplc.autocreate_ord  custrcvplc_autocreate_ord,
custrcvplc.autocreate_inst  custrcvplc_autocreate_inst,
custrcvplc.autocreate_act  custrcvplc_autocreate_act,
  .loca_id_custrcvplc  loca_id_custrcvplc ,
...
,custrcvplc_autocreate_ord  varchar (1) 
,custrcvplc_autoord_p  numeric (3,0)
,custrcvplc_autocreate_inst  varchar (1) 
,custrcvplc_autocreate_act  varchar (1) 
...
,id  numeric (22,0)
,custrcvplc_person_id_upd  numeric (22,0)
,custrcvplc_id  numeric (22,0)
,loca_id_custrcvplc  numeric (22,0)
