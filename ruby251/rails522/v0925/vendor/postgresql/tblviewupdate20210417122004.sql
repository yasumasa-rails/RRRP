...
custord.shelfnos_id_fm   custord_shelfno_id_fm,
  ...
  shelfno_fm.shelfno_code_fm  shelfno_code_fm_fm ,
  shelfno_fm.shelfno_name_fm  shelfno_name_fm_fm ,
  shelfno_fm.shelfno_loca_id_shelfno_fm  shelfno_loca_id_shelfno_fm_fm ,
  shelfno_fm.loca_code_shelfno_fm  loca_code_shelfno_fm_fm ,
  shelfno_fm.loca_name_shelfno_fm  loca_name_shelfno_fm_fm ,
  chrg_cpo.person_name_chrg_cpo  person_name_chrg_cpo_cpo ,
  chrg_cpo.person_code_chrg_cpo  person_code_chrg_cpo_cpo ,
  chrg_cpo.loca_code_sect_chrg_cpo  loca_code_sect_chrg_cpo_cpo ,
  chrg_cpo.loca_name_sect_chrg_cpo  loca_name_sect_chrg_cpo_cpo ,
  chrg_cpo.person_sect_id_chrg_cpo  person_sect_id_chrg_cpo_cpo ,
  chrg_cpo.scrlv_code_chrg_cpo  scrlv_code_chrg_cpo_cpo ,
  chrg_cpo.chrg_person_id_chrg_cpo  chrg_person_id_chrg_cpo_cpo ,
  chrg_cpo.usrgrp_code_chrg_cpo  usrgrp_code_chrg_cpo_cpo ,
  chrg_cpo.usrgrp_name_chrg_cpo  usrgrp_name_chrg_cpo_cpo 
...
,person_code_chrg_cpo_cpo  varchar (50) 
,person_name_chrg_cpo_cpo  varchar (100) 
,usrgrp_name_chrg_cpo_cpo  varchar (100) 
,loca_name_sect_chrg_cpo_cpo  varchar (100) 
,loca_code_sect_chrg_cpo_cpo  varchar (50) 
,usrgrp_code_chrg_cpo_cpo  varchar (50) 
,scrlv_code_chrg_cpo_cpo  varchar (50) 
...
,loca_code_shelfno_fm_fm  varchar (50) 
,shelfno_code_fm_fm  varchar (50) 
,custrcvplc_stktaking_proc  varchar (1) 
,shelfno_name_fm_fm  varchar (100) 
,loca_name_shelfno_fm_fm  varchar (100) 
...
,person_sect_id_chrg_cpo_cpo  numeric (22,0)
,custord_prjno_id  numeric (38,0)
,chrg_person_id_chrg_cpo_cpo  numeric (38,0)
,custord_custrcvplc_id  numeric (38,0)
,shelfno_loca_id_shelfno_fm_fm  numeric (38,0)
