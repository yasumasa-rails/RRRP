...
custord.prjnos_id   custord_prjno_id,
 ...
 from custords   custord,
  r_locas  loca_fm ,  r_locas  loca_to ,  r_custs  cust ,  r_persons  person_upd ,  r_opeitms  opeitm ,  r_chrgs  chrg_cpo ,  r_prjnos  prjno 
  where       custord.locas_id_fm = loca_fm.id      and custord.locas_id_to = loca_to.id      and custord.custs_id = cust.id      and custord.persons_id_upd = person_upd.id      and custord.opeitms_id = opeitm.id      and custord.chrgs_id_cpo = chrg_cpo.id      and custord.prjnos_id = prjno.id     ;
