...
ActiveRecord::Schema.define(version: 20180201132049) do
  ...
  add_foreign_key "reports", "screens", column: "screens_id", name: "report_screens_id"
  ...
  add_foreign_key "tblinks", "screens", column: "screens_id_src", name: "tblink_screens_id_src"
