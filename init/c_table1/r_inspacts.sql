...
--- drop view r_inspacts cascade  
 create or replace view r_inspacts as select  
...
inspact.sno_purord  inspact_sno_purord,
inspact.sno_inspord  inspact_sno_inspord,
inspact.qty_fail  inspact_qty_fail,
...
inspact.reasons_id   inspact_reason_id,
...
inspact.id  inspact_id,
inspact.id id,
inspact.isudate  inspact_isudate,
inspact.rcptdate  inspact_rcptdate,
inspact.qty  inspact_qty,
  prjno.prjno_code_chil  prjno_code_chil ,
inspact.lotno  inspact_lotno,
inspact.packno  inspact_packno,
inspact.price  inspact_price,
inspact.amt  inspact_amt,
inspact.tax  inspact_tax,
inspact.contract_price  inspact_contract_price,
inspact.cno  inspact_cno,
inspact.gno  inspact_gno,
inspact.itm_code_client  inspact_itm_code_client,
inspact.sno  inspact_sno,
inspact.contents  inspact_contents,
  opeitm.opeitm_processseq  opeitm_processseq ,
inspact.remark  inspact_remark,
inspact.expiredate  inspact_expiredate,
inspact.suppliers_id   inspact_supplier_id,
inspact.locas_id_to   inspact_loca_id_to,
inspact.prjnos_id   inspact_prjno_id,
inspact.opeitms_id   inspact_opeitm_id,
inspact.chrgs_id   inspact_chrg_id,
  opeitm.opeitm_priority  opeitm_priority ,
  prjno.prjno_code  prjno_code ,
inspact.shelfnos_id_act   inspact_shelfno_id_act,
inspact.persons_id_upd   inspact_person_id_upd,
inspact.update_ip  inspact_update_ip,
inspact.created_at  inspact_created_at,
inspact.updated_at  inspact_updated_at,
 ...
 from inspacts   inspact,
  r_reasons  reason ,  r_suppliers  supplier ,  r_locas  loca_to ,  r_prjnos  prjno ,  r_opeitms  opeitm ,  r_chrgs  chrg ,  r_shelfnos  shelfno_act ,  r_persons  person_upd 
  where       inspact.reasons_id = reason.id      and inspact.suppliers_id = supplier.id      and inspact.locas_id_to = loca_to.id      and inspact.prjnos_id = prjno.id      and inspact.opeitms_id = opeitm.id      and inspact.chrgs_id = chrg.id      and inspact.shelfnos_id_act = shelfno_act.id      and inspact.persons_id_upd = person_upd.id     ;
 DROP TABLE IF EXISTS sio.sio_r_inspacts;
 CREATE TABLE sio.sio_r_inspacts (
          sio_id numeric(38,0)  CONSTRAINT SIO_r_inspacts_id_pk PRIMARY KEY           ,sio_user_code numeric(38,0)
...
,inspact_cno  varchar (40) 
,inspact_sno  varchar (40) 
,inspact_gno  varchar (40) 
...
,inspact_rcptdate   timestamp(6) 
,inspact_price  numeric (38,4)
,inspact_expiredate   date 
,inspact_sno_purord  varchar (50) 
,inspact_sno_inspord  varchar (50) 
,inspact_qty_fail  numeric (22,5)
,inspact_isudate   timestamp(6) 
,inspact_qty  numeric (18,4)
,inspact_tax  numeric (38,4)
,inspact_contract_price  varchar (1) 
,inspact_lotno  varchar (50) 
,inspact_itm_code_client  varchar (50) 
,inspact_packno  varchar (10) 
,inspact_amt  numeric (18,4)
...
,inspact_contents  varchar (4000) 
,inspact_remark  varchar (4000) 
,inspact_created_at   timestamp(6) 
,inspact_updated_at   timestamp(6) 
,inspact_supplier_id  numeric (22,0)
,inspact_loca_id_to  numeric (38,0)
,inspact_prjno_id  numeric (38,0)
,inspact_opeitm_id  numeric (38,0)
,id  numeric (38,0)
,inspact_chrg_id  numeric (38,0)
,inspact_reason_id  numeric (22,0)
,inspact_shelfno_id_act  numeric (38,0)
,inspact_person_id_upd  numeric (38,0)
,inspact_id  numeric (38,0)
,inspact_update_ip  varchar (40) 
...
,chrg_person_id_chrg_supplier  numeric (38,0)
 ...
 CREATE INDEX sio_r_inspacts_uk1 
  ON sio.sio_r_inspacts(sio_user_code,sio_session_counter,sio_session_id,sio_Command_Response); 

 drop sequence  if exists sio.sio_r_inspacts_seq ;
 create sequence sio.sio_r_inspacts_seq ;