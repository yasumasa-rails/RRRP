...
purinst.shelfcode  purinst_shelfcode,
...
purinst.duedate  purinst_duedate,
 ...
 from purinsts   purinst,
  r_prjnos  prjno ,  r_chrgs  chrg ,  r_suppliers  supplier ,  r_persons  person_upd ,  r_opeitms  opeitm ,  r_locas  loca_to 
  where       purinst.prjnos_id = prjno.id      and purinst.chrgs_id = chrg.id      and purinst.suppliers_id = supplier.id      and purinst.persons_id_upd = person_upd.id      and purinst.opeitms_id = opeitm.id      and purinst.locas_id_to = loca_to.id     ;
