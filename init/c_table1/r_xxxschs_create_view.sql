...
custsch.prjnos_id   custsch_prjno_id,
 ...
 from custschs   custsch,
  r_custs  cust ,  r_persons  person_upd ,  r_opeitms  opeitm ,  r_shelfnos  shelfno_fm ,  r_prjnos  prjno 
  where       custsch.custs_id = cust.id      and custsch.persons_id_upd = person_upd.id      and custsch.opeitms_id = opeitm.id      and custsch.shelfnos_id_fm = shelfno_fm.id      and custsch.prjnos_id = prjno.id     ;
