...
nditm.expiredate  nditm_expiredate,
 ...
 from nditms   nditm,
  r_itms  itm_nditm ,  r_locas  loca_nditm ,  r_persons  person_upd ,  r_opeitms  opeitm 
  where       nditm.itms_id_nditm = itm_nditm.id      and nditm.locas_id_nditm = loca_nditm.id      and nditm.persons_id_upd = person_upd.id      and nditm.opeitms_id = opeitm.id     ;
