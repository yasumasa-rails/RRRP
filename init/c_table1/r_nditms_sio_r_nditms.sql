...
nditm.byproduct  nditm_byproduct,
  ...
  itm_nditm.classlist_contents  classlist_contents_nditm ,
...
nditm.opeitms_id   nditm_opeitm_id,
 ...
 from nditms   nditm,
  r_locas  loca_fm ,  r_itms  itm_nditm ,  r_persons  person_upd ,  r_opeitms  opeitm 
  where       nditm.locas_id_fm = loca_fm.id      and nditm.itms_id_nditm = itm_nditm.id      and nditm.persons_id_upd = person_upd.id      and nditm.opeitms_id = opeitm.id     ;
...
,classlist_contents_nditm  varchar (4000) 
