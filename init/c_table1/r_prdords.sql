...
purord.shelfname  purord_shelfname,
...
purord.isudate  purord_isudate,
 ...
 from purords   purord,
  r_prjnos  prjno ,  r_suppliers  supplier ,  r_crrs  crr_pur ,  r_chrgs  chrg ,  r_persons  person_upd ,  r_locas  loca_to ,  r_opeitms  opeitm 
  where       purord.prjnos_id = prjno.id      and purord.suppliers_id = supplier.id      and purord.crrs_id_pur = crr_pur.id      and purord.chrgs_id = chrg.id      and purord.persons_id_upd = person_upd.id      and purord.locas_id_to = loca_to.id      and purord.opeitms_id = opeitm.id     ;
