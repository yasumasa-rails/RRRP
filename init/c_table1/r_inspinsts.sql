...
inspinst.updated_at  inspinst_updated_at,
 ...
 from inspinsts   inspinst,
  ...
  where       inspinst.suppliers_id = supplier.id      and inspinst.locas_id_to = loca_to.id      and inspinst.prjnos_id = prjno.id      and inspinst.opeitms_id = opeitm.id      and inspinst.chrgs_id = chrg.id      and inspinst.persons_id_upd = person_upd.id     ;
...
,opeitm_loca_id  numeric (38,0)
 ...
 drop sequence  if exists sio.sio_r_inspinsts_seq ;
 create sequence sio.sio_r_inspinsts_seq ;
