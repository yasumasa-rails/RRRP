...
opeitm.update_ip  opeitm_update_ip,
 ...
 from opeitms   opeitm,
  r_locas  loca ,  r_itms  itm ,  r_shelfnos  shelfno ,  r_boxes  boxe ,  r_units  unit_case ,  r_units  unit_prdpurshp ,  r_persons  person_upd 
  where       opeitm.locas_id = loca.id      and opeitm.itms_id = itm.id      and opeitm.shelfnos_id = shelfno.id      and opeitm.boxes_id = boxe.id      and opeitm.units_id_case = unit_case.id      and opeitm.units_id_prdpurshp = unit_prdpurshp.id      and opeitm.persons_id_upd = person_upd.id     ;
